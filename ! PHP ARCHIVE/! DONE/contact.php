<?php require('head.php'); ?>
                <div class="content container">
                    ...
                    <ul>
                        <li><b class="red">Business</b>: <a href="mailto:business@uwave.fm">business@uwave.fm</a></li>
                        <li><b class="red">Programming</b>: <a href="mailto:programming@uwave.fm">programming@uwave.fm</a></li>
                        <li><b class="red">Promotions</b>: <a href="mailto:promotions@uwave.fm">promotions@uwave.fm</a></li>
                        <li><b class="red">Technology</b>: <a href="mailto:tech@uwave.fm">tech@uwave.fm</a></li>
                    </ul>
                    <br />
